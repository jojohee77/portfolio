            ...
            <div className="text-center mb-10">
              <div className="flex flex-col items-center gap-3 mb-8">
                ...
                <p className="text-muted-foreground text-base font-semibold">
                  계약부터 키워드 성과까지, AI 마케팅 통합 솔루션
                </p>
              </div>
              <p className="text-xl font-semibold text-neutral-900 whitespace-nowrap">
                김태현님이 워크스페이스1(으)로 초대하였습니다.
              </p>
            </div>

            <div className="space-y-4 mb-0 flex flex-col items-center">
              <Button
                onClick={handleEmailLogin}
                className="flex w-full max-w-[300px] h-[50px] items-center justify-center rounded-xl font-semibold text-sm transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
                style={{
              ...
              <Button
                ...
                className="flex w-full max-w-[300px] h-[50px] items-center justify-center rounded-xl font-semibold text-sm text-white transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
                style={{
              ...
              <Button
                ...
                variant="outline"
                className="flex w-full max-w-[300px] h-[50px] items-center justify-center rounded-xl font-semibold text-sm border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
              >
